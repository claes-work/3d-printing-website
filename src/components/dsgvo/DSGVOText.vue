<template>
  <section>
    <div class="container">
      ...
      <p>Hostinger<br />
        Kaunas, Litauen. Hostinger, UAB. Jonavos g. 60C, 44192.</p>
      ...
      dieser Website ist:</p> <p>Sebastian Claes<br />
      Lindenstra&szlig;e 10,<br />
      14913 J&uuml;terbog<br />
      Deutschland</p>
      <p>Telefon: +49 176 614 759 65<br />
        E-Mail: info@3d-druck-jueterbog.de</p>
      ...
      Google Ireland Limited (&bdquo;Google&ldquo;), Gordon House, Barrow Street, Dublin 4, Irland.</p> <p>Wenn Sie
      ...
      <p>Des Weiteren kann YouTube verschiedene Cookies auf Ihrem Endger&auml;t speichern oder vergleichbare
        ...
        vorzubeugen.</p> <p>Wenn Sie in Ihrem YouTube-Account eingeloggt sind, erm&ouml;glichen Sie YouTube, Ihr
      Surfverhalten direkt Ihrem pers&ouml;nlichen Profil zuzuordnen. Dies k&ouml;nnen Sie verhindern, indem Sie sich
      aus Ihrem YouTube-Account ausloggen.</p> <p>Die Nutzung von YouTube erfolgt im Interesse einer
...
noreferrer">https://policies.google.com/privacy?hl=de</a>.</p>
      ...
      Verarbeitung ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und &sect; 25 Abs. 1 TTDSG, soweit
